...
class Metodos:
    ...
    def crear_polinomio(self):
        ...
        # print(list(reversed(self.coeficientes)))

        #Evaluacion de un polinomio: https://interactivechaos.com/es/manual/tutorial-de-numpy/evaluacion-de-un-polinomio
        polinomio = np.polynomial.polynomial.Polynomial(list(reversed(self.coeficientes)))
    ...
    def establecer_funcion(self):
        ...
        match funcion:
            ...
            case 3:
                return math.exp
            case 4:
                return self.crear_polinomio()
            case 5:
                print("\n\nSuponiendo que la raíz tiene un polimomio dentro")
                polinomio = self.crear_polinomio()
                def sqrt_polinomio(x):
                    return math.sqrt(polinomio(x))
                return sqrt_polinomio
...
aproxMonteCarlo = Montecarlo(condiciones.n, condiciones.a, condiciones.b)
print("\nMétodo de MonteCarlo: ")
print(f"Aproximación: {aproxMonteCarlo.sumatoria(fx)}")